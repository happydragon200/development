  ...
  return (
    <>
      ...
      const foods = [
        {
          name: "toast", 
          type: "bread", price: 5, img: {toast}, count: {toast_count}},
        {name: "cheese", type: "protein", price: 10 img: {cheese}, count: {cheese_count}},
        {name: "waffle", type: "bread", price: 100, img: {waffle}, count: {waffle_count}},
